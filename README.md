...
| `windowPosition`  | Position of the first window (window1).<br>[window2 is either 5px below or to the right of this window, depending on layout] (optional as it can be set in the windows object) | { x: 5, y: 225 } |
