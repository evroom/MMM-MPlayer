...
| `rtspStreamOverTcp`  | Used with 'rtsp://' URLs to specify that the resulting incoming RTP and RTCP packets be streamed over TCP.<br>**Possible values:** `true` \| `false`<br>**Default value:** `false` |
